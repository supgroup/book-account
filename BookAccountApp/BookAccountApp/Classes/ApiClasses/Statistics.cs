                    ...
                    List = (from S in entity.serviceData
                          ...
                          //  where (S.systemType == systemType)
                            select new BookSts()
                            {
                                ...
                                paid = S.paid,
                                profit = S.systemType == "soto" ? (S.profit * S.syValue) : S.profit,
                                notes = S.notes,
                                state = S.state,
                                ...
                                office_commission_value = S.systemType == "soto" ?( S.office_commission_value * S.syValue) : S.office_commission_value,
                                office_commission_ratio = S.office_commission_ratio,
                                company_commission_value = S.systemType == "soto" ? (S.company_commission_value * S.syValue) : S.company_commission_value,
                                company_commission_ratio = S.company_commission_ratio,
                                totalnet = S.systemType == "soto" ? (S.totalnet * S.syValue) : S.totalnet,
                                passengerPaid = S.passengerPaid,
                                passengerUnpaid = S.passengerUnpaid,
                                officePaid = S.systemType == "soto" ? (S.officePaid * S.syValue) : S.officePaid,
                                officeUnpaid = S.systemType == "soto" ? (S.officeUnpaid * S.syValue) : S.officeUnpaid,
                                airlinePaid = S.airlinePaid,
                                airlineUnpaid = S.airlineUnpaid,
                                systemPaid = S.systemType == "soto" ? (S.systemPaid * S.syValue) : S.systemPaid,
                                systemUnpaid = S.systemType == "soto" ? (S.systemUnpaid * S.syValue) : S.systemUnpaid,
                                exchangeId = S.exchangeId,
                                osId = S.osId,
                                systemId = S.systemId,
                                syValue = S.syValue,
                                tax_ratio = S.tax_ratio,
                                tax_value = S.systemType == "soto" ? (S.tax_value * S.syValue) : S.tax_value,
                                systemName = SYS.name,
